...
const Usuario = ({ alIrADashboard }) => {
  // Datos simulados de POE para el usuario
  ...
  const handleEnviarSolicitud = (e) => {
    e.preventDefault();
    console.log("Datos de Solicitud P.O.E:", {
      montoSolicitado,
      cuotas,
      motivo,
      objetoEmpeño,
      estadoObjeto,
      valorEstimado,
      imagenesCargadas: imagenes.length,
    });
    alert(
  ...
  const handleIrDashboardSecundario = () => {
    // Ejecuta la función heredada de App.jsx para cambiar de pantalla de inmediato
    if (alIrADashboard) {
      alIrADashboard();
    }
  };
            ...
            <div className="p-8 space-y-6">
              <div className="border-b border-slate-100 pb-4">
                ...
                <span className="text-xs text-slate-500 font-mono">
                  ID de Cuenta: {userData.codigoCliente}
                </span>
              </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <div className="bg-slate-50 p-5 rounded-xl border border-slate-100 flex flex-col justify-between">
                  ...
                  <span className="self-start inline-flex items-center px-3 py-1 rounded-full text-xs font-bold bg-emerald-100 text-emerald-800 mt-2">
                    ● {userData.estado}
                  </span>
                </div>
              </div>
